...
export default function PolicyModal({ type, isOpen, onClose }) {
  ...
  const contentMap = {
    ...
    returns: {
      title: 'سياسة التجربة والاستبدال',
      subtitle: 'معاينة وقياس فورية عند باب المنزل لضمان التنسيق والمقاس المثالي',
      icon: <RefreshCw size={28} color="var(--gold)" />,
      badge: 'الاستبدال الفوري عند التوصيل',
      sections: [
        {
          heading: '1. التبديل الفوري عند التسليم (داخل الأردن فقط)',
          text: 'التبديل متاح حصرياً داخل المملكة الأردنية الهاشمية ويتم فوراً في نفس وقت التوصيل عند باب المنزل؛ حيث يربض كابتن التوصيل عند باب المنزل حتى تقوم العميلة بتجربة العباءة، معاينة القماش والمقاس، وأخذ رأي أهل بيتها بكامل الراحة.'
        },
        {
          heading: '2. قرار الاستلام أو التبديل اللحظي',
          text: 'بعد قياس العباءة والمعاينة فوراً أثناء تواجد كابتن التوصيل، تُبلغ العميلة الكابتن في نفس اللحظة إما بتأكيد الرغبة بالقطعة أو طلب تبديلها بمقاس آخر أو موديل آخر فوراً.'
        },
        {
        ...
        {
          heading: '4. انتهاء مهلة التبديل',
          text: 'بمجرد انتهاء التجربة ومغادرة كابتن التوصيل وتأكيد الاستلام، يُعتبر الطلب مكتظاً ونهائياً ولا يُتاح التبديل بعد مغادرة الكابتن.'
        }
      ]
    },
