...
db.getConnection((err, connection) => {
  ...
  const checkColumns = async () => {
    try {
      ...
      // ──────────────────────────────────────────────────────────────────
      // ──────────────────────────────────────────────────────────────────
      // ULTIMATE IMAGE AUTO-REPAIR & DIVERSIFICATION MIGRATION
      // Ensures ALL products have distinct, working, real abaya photos from disk
      // ──────────────────────────────────────────────────────────────────
      try {
        ...
        for (let index = 0; index < items.length; index++) {
          ...
          if (item.image_url && item.image_url !== '12.png' && item.image_url !== '/12.png') {
            ...
            // Assign a unique distinct photo from catalog based on product ID
