...
const fedexCode = `
// ══════════════════════════════════════════════════════════════════════════════
// 📦 FedEx Official Integration APIs
// ══════════════════════════════════════════════════════════════════════════════
...
app.post("/api/fedex/create-shipment", async (req, res) => {
  try {
...
for (const t of targets) {
  ...
  if (code.includes('/api/fedex/create-shipment')) {
    console.log(`ℹ️ ${t} already has FedEx routes`);
    continue;
  }
  ...
  if (code.includes(anchor)) {
    ...
    console.log(`✅ Patched FedEx routes into ${t}`);
  } else {
